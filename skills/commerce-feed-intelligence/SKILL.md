...
description: Use when product feeds, merchant catalogs, structured attributes, compatibility, use cases, substitutions, inventory, price, or policy data affect discovery or shopping performance.
---

# Commerce Feed Intelligence

**Goal:** Turn the product feed into a truthful semantic decision asset for conversational and agent-mediated discovery.
...
- Applied theories: `product-feed-semantic-completeness`
- Router: `../../neural/graph.json` and `../../scripts/neural_router.py`
- Hooks: `../../hooks/commerce-feed-readiness.md`, `../../hooks/evidence-gate.md`, `../../hooks/freshness-check.md`
